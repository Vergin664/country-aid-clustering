...
with open('Final_model_pkl','rb') as file:
...
def main():
    ...
    exp = st.text_input('Enter Exports (% GPD):')
    imp = st.text_input('Enter Imports (% GPD):')
    hel = st.text_input('Enter expenditure on health (% GPD):')
